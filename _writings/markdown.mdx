...
coverImage: /assets/writings/markdown/cover.jpeg
description: Mimic Gatsby Theme Novela by Narative with NextJS
author:
  name: Alfie Qashwa
  picture: /assets/writings/author/avatar.jpeg
---

Trying mimic `@narative/gatsby-theme-novela` using NextJS. Novela is built by the team at [Narative](https://narative.co), and built for everyone that loves the web.
...
<div className='Image__Small'>
  <img src='./images/vaping.jpeg' title='Logo Title Text 1' alt='Small Image' />
</div>
...
<div className='Image__Large'>
  <img src='./images/vaping.jpeg' title='Logo Title Hero' alt='Large Image' />
</div>
...
const Title = () => (
  <h2 style={{ color: 'palevioletred', textAlign: 'center' }}>
    Cello{' '}
    <span img='role' style={{ fontSize: '10em' }}>
      🌏
    </span>
    <br />
